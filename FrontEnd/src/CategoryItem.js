...
function CategoryItem() {
    ...
    useEffect(() => {
        fetch(`http://127.0.0.1:5000/category/id:${category_id}`).then((result) => {
                                        ...
                                        <h2 style={{ marginLeft: "10px" }}>{all_item_details.item_category_name}
                                            <span style={{ float: "right", marginRight: "10px" }}>
                                                <Dropdown>
                                                    ...
                                                    <Dropdown.Menu>
                                                        <Dropdown.Item href="#lowtohigh">Low to High</Dropdown.Item>
                                                        <Dropdown.Item href="#hightolow">High to Low</Dropdown.Item>
                                                    </Dropdown.Menu>
                                                </Dropdown>
                                            </span>
                                        </h2>
